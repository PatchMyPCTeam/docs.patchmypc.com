...
<p>Some customers choose to use the [Notify the user to close the application](policy-section.md#notify-the-user-to-close-the-application) policy for applications, such as web browsers, to ensure they are closed before updating. This helps ensure that when the user next launches the application, it is immediately running the updated version.</p>
