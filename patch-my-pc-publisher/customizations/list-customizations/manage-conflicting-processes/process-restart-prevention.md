...
<p>For this reason, if users are blocked from launching an application due to leftover Image File Execution Options entries, a manual registry cleanup or [PowerShell based remediation](process-restart-prevention.md#powershell-based-remediation) is often required to immediately restore application access.</p>
</blockquote>
