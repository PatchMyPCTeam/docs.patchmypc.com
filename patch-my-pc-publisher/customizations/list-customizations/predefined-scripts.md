...
![Recommended Scripts](/_images/image-(4418).png "Recommended Scripts")
...
<p>**Note**</p>
<p>Recommended scripts are hosted by PMPC and are referenced by URL. They are not editable from the Publisher UI.</p>
</blockquote>
