...
When this option is used, Publisher automatically configures the operating system and architecture requirements for the application. These requirements are applied to the deployment type in ConfigMgr or to the requirement rules on the Win32 app in Intune. Only devices that meet the configured requirements are considered applicable when the application is deployed.
...
![Requirement set on the Deployment Type](/_images/image-(3992).png "Requirement set on the Deployment Type")
...
![Requirement set on the Win32 app](/_images/image-(3998).png "Requirement set on the Win32 app")
...
<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>In ConfigMgr, ARM64 applications are also restricted to workstation operating systems by default.</p>
</blockquote>
...
![Example ConfigMgr ARM64 Application Requirements](/_images/image-(3993).png "Example ConfigMgr ARM64 Application Requirements")

<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>For more information on how the Publisher handles ARM64 support for apps, see [ARM Architecture Application Support](../../../patch-my-pc-publisherv2/administration/advanced/arm-architecture-application-support.md).</p>
</blockquote>
...
<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>In ConfigMgr, applications can also be restricted to workstation or server operating systems.</p>
</blockquote>
...
![64-bit and ARM64 Requirement](/_images/image-(3996).png "64-bit and ARM64 Requirement")

<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>These variances across 64-bit applications are intentional and are determined by the Patch My PC catalog team during application testing. ARM64 support is enabled only when it is considered appropriate for the specific application to avoid installation failures on unsupported devices.</p>
</blockquote>
...
![Confirm ARM64 OS Requirement](/_images/image-(3995).png "Confirm ARM64 OS Requirement")
...
![32-bit Application Requirements](/_images/image-(3997).png "32-bit Application Requirements")
