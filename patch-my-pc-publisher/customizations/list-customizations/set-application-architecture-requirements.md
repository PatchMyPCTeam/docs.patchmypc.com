...
When you use this option, Publisher automatically configures the operating system and architecture requirements for the application. These requirements are applied to the deployment type in Microsoft Configuration Manager (ConfigMgr) or to the requirement rules on the Win32 app in Intune. Only devices that meet the configured requirements are considered applicable when the application is deployed.
...
Applications built specifically for ARM64 have an **ARM64** suffix in the application name.
...
<figure><img src="../../../.gitbook/assets/image (1003).png" alt="Example ConfigMgr ARM64 Application Requirements" width="375"><figcaption></figcaption></figure>
...
For applications where **Install on ARM64 OS** is not enabled by default, you can optionally enable it if the application is known to support ARM64 execution. When you enable this option, you are prompted to confirm the change is intentional.

<figure><img src="../../../.gitbook/assets/image (1005).png" alt="Architecture Selection Warning" width="449"><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (1006).png" alt="32-bit Application Requirements" width="375"><figcaption></figcaption></figure>
