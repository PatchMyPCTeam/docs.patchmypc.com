...
!['Manage Application Assignments' form](/_images/image-(4766).png "&#x27;Manage Application Assignments&#x27; form")
...
<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>When an **Available** assignment targets a device-based Entra ID group, only the device's primary user will see the application in the Company Portal. Other users who sign in to the same device will not see the app listed.</p>
</blockquote>
