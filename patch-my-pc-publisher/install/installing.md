...
!['Welcome' screen](../../.gitbook/assets/image-\(4756\).png)
...
!['End-User License Agreement' screen](../../.gitbook/assets/image-\(4757\).png)
...
!['Enable Intune Standalone Mode' screen](../../.gitbook/assets/image-\(4759\).png)
...
!['Select Installation Folder' screen](../../.gitbook/assets/image-\(4760\).png)

6. On the **Ready to Install** screen, click **Install.**

!['Ready to Install' screen](../../.gitbook/assets/image-\(4761\).png)

7. Click **Yes** if you receive a UAC prompt.\
   \
   Publisher is then installed.

![Publisher installation begins](../../.gitbook/assets/image-\(4762\).png)
...
!['Completion' screen](../../.gitbook/assets/image-\(4763\).png)
