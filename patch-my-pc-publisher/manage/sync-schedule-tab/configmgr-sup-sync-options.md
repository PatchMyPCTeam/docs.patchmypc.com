...
!['ConfigMgr SUP Sync Options' section](/_images/image-(4863).png "&#x27;ConfigMgr SUP Sync Options&#x27; section")
...
<p>**Important**</p>
<p>Before you can use enable this option, you need to [configure the SMS Provider connection](../configmgr-apps-tab/base-install-options/connection-source-options.md#configure-sms-provider-connection).</p>
</blockquote>