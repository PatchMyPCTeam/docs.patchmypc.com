...
Publisher automatically creates a root **Applications** folder in the configured UNC source path, which you cannot modify.
{% endhint %}
...
See [Content Source Folder](../../../requirements/configmgr-requirements/permissions.md#content-source-folder) for more information on requirements.
{% endhint %}
