...
<blockquote class="wp-block-quote">
<p>**Important**</p>
<p>These rules rely on the same ConfigMgr database access and SQL permissions described earlier in this document under [Database Authentication](scan-configmgr.md#database-authentication).</p>
</blockquote>
...
<blockquote class="wp-block-quote">
<p>**Important**</p>
<p>While it may be tempting to set the device threshold to a very low number, even one, this is generally not recommended for most environments. This would be especially impactful for new customers who have not yet reviewed and enabled products in the product tree, as a very low threshold can cause newly discovered applications to be enabled simultaneously, potentially resulting in a large number of updates being synchronized at once.</p>
</blockquote>
