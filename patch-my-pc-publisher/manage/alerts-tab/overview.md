# Overview of Alerts in Patch My PC Publisher
...
!['Alerts' tab](../../../.gitbook/assets/image-\(4864\).png)
...
Publisher supports both email and webhook notification delivery methods. They can notify when apps and updates are published successfully, when updates are skipped due to configuration, or when errors occur that require attention.
