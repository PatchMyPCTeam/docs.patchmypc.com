...
![ConfigMgr/WSUS Product Management](/_images/image-(88).png)
...
![WSUS Products and Classifications](/_images/image-(89).png)
...
![%ProgramFiles%\Patch My PC\Patch My PC Publishing Service\Logs\PatchMyPC-SmsProviderConfigMgrRepository.log](/_images/image-(465).png)