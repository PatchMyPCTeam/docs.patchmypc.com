...
<blockquote class="wp-block-quote">
<p>**Tip**</p>
<p>This form control will use the Entra ID App Registration, configured from the [Options](../../../patch-my-pc-publisherv2/administration/intune-apps-updates/options/) button, to connect to Microsoft Graph to retrieve data from the Intune Reporting Endpoint. For more details about the required API permissions and authentication options, see [Entra ID App Registration](../../../patch-my-pc-publisherv2/publisher-requirements/intune-requirements/entra-id-app-registration/).</p>
</blockquote>
