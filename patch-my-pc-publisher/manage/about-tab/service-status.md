...
!['Sync Status' section](/_images/image-(4836).png "&#x27;Sync Status&#x27; section")
...
<p>**Note**</p>
<p>See the [Status](../sync-schedule-tab/sync-status.md#status) section of [Sync Status](../sync-schedule-tab/sync-status.md) for more details on the values of the **Status** field.</p>
</blockquote>
...
!['Publisher Statistics' section](/_images/image-(4837).png "&#x27;Publisher Statistics&#x27; section")
