...
![Show Package Info](/_images/image-(157).png "Show Package Info")
...
![Package Details](/_images/image-(159).png "Package Details")
...
<p>**Note**</p>
<p>This information is useful when validating that you have the correct installer file while publishing a binary free application and manually placing the installer in the [Local Content Repository](../administration/advanced/local-content-repository.md).</p>
</blockquote>
