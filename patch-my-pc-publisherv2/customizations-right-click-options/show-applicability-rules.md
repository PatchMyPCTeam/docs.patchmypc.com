...
![Show Applicability Rules](/_images/image-(78).png "Show Applicability Rules")
...
<p>**Note**</p>
<p>This option is informational only. The applicability rules cannot be edited from this window. However, the XML content can be selected and copied to the clipboard for review or analysis.</p>
</blockquote>

When you select **Show Applicability Rules**, a window opens displaying the following sections for the selected update.

![Applpicability Rules](/_images/image-(79).png "Applpicability Rules")
...
![Applicability Rules Explained](/_images/image-(80).png "Applicability Rules Explained")
