...
![Set Application Requirements](/_images/image-(3990).png "Set Application Requirements")
...
<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>For more information on how the Publisher handles ARM64 support for apps, see [ARM Architecture Application Support](../administration/advanced/arm-architecture-application-support.md).</p>
</blockquote>
