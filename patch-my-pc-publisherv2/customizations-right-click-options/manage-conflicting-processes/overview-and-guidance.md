...
![Manage Conflicting Processes](/_images/image-(3964).png "Manage Conflicting Processes")
...
![Product Tree icon indicating the Manage Conflicting Processes feature should be configured](/_images/image-(3966).png "Product Tree icon indicating the Manage Conflicting Processes feature should be configured")
...
<p>**Important**</p>
<p>The closed applications are not automatically reopened after the update completes. Application relaunch behavior depends on the application itself or user action.</p>
</blockquote>
