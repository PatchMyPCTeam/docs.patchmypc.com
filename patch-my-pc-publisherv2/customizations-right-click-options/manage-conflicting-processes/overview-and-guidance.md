...
![Manage Conflicting Processes](../../../.gitbook/assets/image-\(3964\).png)
...
![Product Tree icon indicating the Manage Conflicting Processes feature should be configured](../../../.gitbook/assets/image-\(3966\).png)
