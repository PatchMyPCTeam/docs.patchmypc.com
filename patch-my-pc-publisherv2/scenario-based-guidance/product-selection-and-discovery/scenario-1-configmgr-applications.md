# Scenario 1: ConfigMgr Applications

_Applies to: Patch My PC Publisher V2.x_

## Overview

This page provides guidance on how to discover applications in your environment or manually select products for publishing as ConfigMgr applications using the Publisher.
...
* [Automatically discover installed products by scanning the ConfigMgr database using the Scan Wizard](scenario-1-configmgr-applications.md#automatically-discover-installed-products-by-scanning-the-configmgr-database-using-the-scan-wizard).
* [Manually browse and select products directly from the product tree on the ConfigMgr Apps tab](scenario-1-configmgr-applications.md#manually-browse-and-select-products-directly-from-the-product-tree-on-the-configmgr-apps-tab).
...
<figure><img src="../../../.gitbook/assets/image (4156).png" alt="ConfigMgr Apps Scan Wizard" width="563"><figcaption></figcaption></figure>
...
Applications can also be enabled manually by selecting products directly from the [product tree](../../administration/configmgr-apps/product-tree.md) on the [ConfigMgr Apps](../../administration/configmgr-apps/) tab.
...
<figure><img src="../../../.gitbook/assets/image (4157).png" alt="Manual Product Selection" width="545"><figcaption></figcaption></figure>
