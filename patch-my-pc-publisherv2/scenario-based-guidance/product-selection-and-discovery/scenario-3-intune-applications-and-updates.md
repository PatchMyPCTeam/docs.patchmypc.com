# Scenario 3: Intune Applications and Updates

_Applies to: Patch My PC Publisher V2.x_

## Overview

This page provides guidance on how to discover applications in your environment or manually select products for publishing as Intune apps and Intune updates using the Publisher.
...
* [Scan Intune for supported products using the Scan Intune for Supported Products wizard](scenario-3-intune-applications-and-updates.md#scan-intune-for-supported-products-using-the-scan-intune-for-supported-products-wizard).
* [Manually browse and select products directly from the product tree on the Intune Apps and Intune Updates tabs](scenario-3-intune-applications-and-updates.md#manually-browse-and-select-products-directly-from-the-product-tree-on-the-intune-apps-and-intune-upd).
...
Once you are comfortable with how applications and updates are created and maintained, you can expand product selections or consider enabling [auto-publishing rules](../../administration/intune-apps-updates/form-controls/scan-intune-for-supported-products.md#auto-publishing-rules) to automate application lifecycle management over time to create new applications and updates based on discovery thresholds.
