...
<p>**Important**</p>
<p>If you plan to deploy third-party update content through a **Cloud Management Gateway (CMG)**, do **not** enable **Allow clients to download delta content when available** in the corresponding Client Settings for clients that connect to a CMG as their management point (MP) and software update point (SUP).</p>
...
<p>Read more at <a href="https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/about-client-settings#allow-clients-to-download-delta-content-when-available">https://learn.microsoft.com/en-us/intune/configmgr/core/clients/deploy/about-client-settings#allow-clients-to-download-delta-content-when-available</a></p>
</blockquote>
