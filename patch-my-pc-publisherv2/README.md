...
Official product documentation for Patch My PC Publisher, our on-premises based solution. "The Publisher" is a lightweight Windows application that helps you to create, update and manage applications in Microsoft ConfigMgr, WSUS and Intune.
...
Curious about what fixes and new features we've added to the Publisher? You can check out our release history in the release history section for our [**Production**](../patch-my-pc-publisher-2/publisher-release-notes/) and [**Preview**](../patch-my-pc-publisher-2/publisher-release-notes/publisher-preview-releases.md) releases:
