# Intune Standalone Options

_Applies to: Patch My PC Publisher V2.x_

**Intune Standalone Options** are used to limit the Publisher to Intune only functionality. These settings hide the ConfigMgr and WSUS related publishing features from the user interface.

![Intune Standalone Options](/_images/image-(176).png "Intune Standalone Options")
...
![Enable Microsoft Intune standalone mode](/_images/image-(177).png "Enable Microsoft Intune standalone mode")
