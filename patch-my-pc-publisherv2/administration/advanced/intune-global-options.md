...
This capability is required if you want to use the [Intune Application Manager](../intune-apps-updates/form-controls/intune-application-manager.md) to extract content from applications or updates that were published by the Publisher.
...
Once **Store encryption information locally to allow extraction of Win32 .intunewin files** is enabled, you can extract content for apps and updates created _after_ the setting was turned on by using the [Intune Application Manager](../intune-apps-updates/form-controls/intune-application-manager.md).
