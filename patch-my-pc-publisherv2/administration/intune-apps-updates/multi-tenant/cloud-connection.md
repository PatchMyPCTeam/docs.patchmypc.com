...
* Create and manage custom applications in the MSP parent Patch My PC Cloud company. See the Publisher [Cloud page](../../cloud.md) for more details on hot to connect the Publisher to a Patch My PC Cloud Company.
...
All custom applications created in the MSP parent Patch My PC Cloud company are made available in the Publisher under the [All Custom Products](../product-tree.md) node. These custom applications are visible in both the Intune Apps and Intune Updates tabs.
