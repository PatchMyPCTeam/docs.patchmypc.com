...
<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>Customers using the legacy provider should plan to migrate to Microsoft Teams Workflow. See [Update a Microsoft Teams Legacy Webhook to Use Workflows](update-a-microsoft-teams-legacy-webhook-to-use-workflows.md) for more information.</p>
</blockquote>
...
<blockquote class="wp-block-quote">
<p>**Important**</p>
<p>**E**nd of synchronization alerts cannot be filtered by specific product. If [Send alerts as each product is published](webhook-configuration.md#send-alerts-as-each-product-is-published) is unchecked, product selection is disabled and all products are included automatically.</p>
</blockquote>
