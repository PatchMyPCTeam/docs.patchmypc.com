...
![Alerts](../../../.gitbook/assets/image-\(4236\).png)
...
The Publisher supports both email and webhook notification delivery methods. They can notify when apps and updates are published successfully, when updates are skipped due to configuration, or when errors occur that require attention.
