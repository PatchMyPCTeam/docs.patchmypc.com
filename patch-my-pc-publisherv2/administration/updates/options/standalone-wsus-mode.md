...
![Standalone WSUS Mode](/_images/image-(93 "Standalone WSUS Mode") (1).png>)
...
> \*\*Note\*\*
>
> For updates published before WSUS Standalone mode was enabled, use the \[Modify Updates Wizard]\(modify-published-updates.md) to make those updates appear in the WSUS console uising the \*\*Show in WSUS\*\* option.
