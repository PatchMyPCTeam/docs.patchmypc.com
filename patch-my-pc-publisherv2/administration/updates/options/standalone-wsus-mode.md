...
<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>For updates published before WSUS Standalone mode was enabled, use the [Modify Updates Wizard](modify-published-updates.md) to make those updates appear in the WSUS console uising the **Show in WSUS** option.</p>
</blockquote>
