...
* **Published updates**\
  The total number of third-party updates that have been published.
* **Published CVEs**\
  The total number of Common Vulnerabilities and Exposures (CVEs) addressed by the applications and updates published through Publisher.
* **Last sync**\
  The date and time of the most recent _successful_ synchronization.
* **Next sync**\
  The scheduled date and time of the next synchronization based on your configured sync schedule.
* **Total syncs**\
  The total number of synchronization operations performed by Publisher.

![Usage statistics for the Publisher](/_images/image-(415).png "Usage statistics for the Publisher")
