...
![Product tree structure](/_images/image-(491).png "Product tree structure")
...
<blockquote class="wp-block-quote">
<p>**Tip**</p>
<p>On the **ConfigMgr Apps** tab, an additional **All Custom Products** tree is available. This tree uses the same hierarchical structure as the **All Products** tree, including the All Products, vendor, and product levels.</p>
...
<p>This tree is not available on the **Updates** tab.</p>
</blockquote>
...
![Product tree selection granularity](/_images/image-(492).png "Product tree selection granularity")
...
![Vendor level selection consideration](/_images/image-(493).png "Vendor level selection consideration")
