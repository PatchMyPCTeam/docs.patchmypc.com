...
![Enable Third  Party Updates and allow Configuration Manager to manage the certificate.](/_images/image-(1814 "Enable Third  Party Updates and allow Configuration Manager to manage the certificate.").png>)
...
![Synchronize Software Updates to generate a new certificate](/_images/image-(1859 "Synchronize Software Updates to generate a new certificate").png>)
...
![Here the certificate exists but has not been checked, select Show Certificate](/_images/image-(1897 "Here the certificate exists but has not been checked, select Show Certificate").png>)

![Here is the information around the generated certificate](/_images/image-(1780 "Here is the information around the generated certificate").png>)

![Note how the checkbox is now green. You are ready to start publishing updates!](/_images/image-(1947 "Note how the checkbox is now green. You are ready to start publishing updates!").png>)