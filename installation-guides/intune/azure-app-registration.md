...
{% hint style="info" %}
Note: To display the _names_ of users or devices inside an Entra ID group when assigning apps or updates in the Publisher, the following Microsoft Graph API permissions are also required:
