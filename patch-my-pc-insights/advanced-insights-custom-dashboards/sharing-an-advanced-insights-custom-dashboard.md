...
![](/_images/image-(2291).png "Required Permissions")
...
![](/_images/image-(2292).png "Dashboard Editor Rights Section")

Custom Dashboards can also be assigned to roles and users in the Administration node for example, to add a custom dashboard to a Role:

![](/_images/image-(2293).png "Adding a Custom Dashboard to a User Role")