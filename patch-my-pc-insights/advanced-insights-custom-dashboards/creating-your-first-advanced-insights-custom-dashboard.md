...
![](/_images/image-(2282).png "Creating a custom dashboard")
...
![](/_images/image-(2283).png "Setting filter options for a dashboard item")
...
![My first custom dashboard](/_images/14.jpg "My first custom dashboard")
