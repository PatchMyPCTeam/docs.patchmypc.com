...
Official product documentation for Patch My PC Publisher
...
{% content-ref url="../installation-guides/configmgr/" %}
[configmgr](../installation-guides/configmgr/)
{% endcontent-ref %}
...
{% content-ref url="../installation-guides/intune/" %}
[intune](../installation-guides/intune/)
{% endcontent-ref %}

## 📄 Release History

Curious about what fixes and new features we've added to the Publisher? You can check out our release history in the release history section for our [**Production**](publisher-release-notes/) and [**Preview**](publisher-release-notes/publisher-preview-releases.md) releases:

{% content-ref url="publisher-release-notes/" %}
[publisher-release-notes](publisher-release-notes/)
{% endcontent-ref %}

{% content-ref url="publisher-release-notes/publisher-preview-releases.md" %}
[publisher-preview-releases.md](publisher-release-notes/publisher-preview-releases.md)
{% endcontent-ref %}
