...
<p>For a detailed explanation on how we collect and process your Intune data, see [Intune Data Collection](../technical-references/data-collected.md).</p>
</blockquote>
...
![Intune tabs](/_images/image-(269).png "Intune tabs")

<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>All views across all tabs apply only to Windows and macOS information.</p>
</blockquote>
...
!['Devices' tab](/_images/image-(22).png "&#x27;Devices&#x27; tab")
...
![Managed Devices (Dash-stat)](/_images/image-(273).png "Managed Devices (Dash-stat)")
...
!['General' tab](/_images/image-(4404).png "&#x27;General&#x27; tab")
...
!['App' tab](/_images/image-(4402).png "&#x27;App&#x27; tab")

**Discovered apps** tab shows a list of discovered apps from Intune device inventory.

!['Discovered apps' tab](/_images/image-(4403).png "&#x27;Discovered apps&#x27; tab")
...
![Low Disk Space % (Dash-stat)](/_images/image-(277).png "Low Disk Space % (Dash-stat)")
...
![Device Encryption (Dash-stat)](/_images/image-(259).png "Device Encryption (Dash-stat)")
...
![Stale Devices (Dash-stat)](/_images/image-(260).png "Stale Devices (Dash-stat)")
...
![Device Types (Donut chart)](/_images/image-(261).png "Device Types (Donut chart)")
...
![Device Details](/_images/image-(4287).png "Device Details")
...
![Managed Devices - Last Check-in (Donut chart)](/_images/image-(265).png "Managed Devices - Last Check-in (Donut chart)")
...
![Devices Not Encrypted (Table list)](/_images/image-(267).png "Devices Not Encrypted (Table list)")
...
![Applications tab](/_images/image-(3861).png "Applications tab")

![Applications tab 2](/_images/image-(3862).png "Applications tab 2")
...
![Managed Apps (Dash-stat)](/_images/image-(3863).png "Managed Apps (Dash-stat)")
...
![App modal Example](/_images/image-(4380).png "App modal Example")
...
!['Install State' tab](/_images/image-(3865).png "&#x27;Install State&#x27; tab")
...
![Modified App – Last 24hrs (Dash-stat)](/_images/image-(3866).png "Modified App – Last 24hrs (Dash-stat)")
...
![Unassigned Apps (Dash-stat)](/_images/image-(3867).png "Unassigned Apps (Dash-stat)")
...
![App Install Failed (Dash-stat)](/_images/image-(3868).png "App Install Failed (Dash-stat)")
...
![Managed Apps (Table list)](/_images/image-(3869).png "Managed Apps (Table list)")
...
![Managed App Types (Donut chart)](/_images/image-(3870).png "Managed App Types (Donut chart)")
...
![Table list view of the full dataset related to the clicked item](/_images/image-(3871).png "Table list view of the full dataset related to the clicked item")
...
![Managed App Install States (Donut chart)](/_images/image-(3872).png "Managed App Install States (Donut chart)")
...
![Table view showing the failed device count grouped by app](/_images/image-(3873).png "Table view showing the failed device count grouped by app")

### Discovered Apps (Dash-stat)

Provides a count of all discovered apps, collected by Intune Inventory.

![Discovered Apps (Dash-stat)](/_images/image-(3874).png "Discovered Apps (Dash-stat)")
...
![Managed Devices - Discovered Apps (Table list)](/_images/image-(3875).png "Managed Devices - Discovered Apps (Table list)")
...
![Discovered app details example](/_images/image-(3876).png "Discovered app details example")
...
![Compliance tab](/_images/image-(3880).png "Compliance tab")

### Managed Devices (Dash-stat)

Provides a total count of all Windows and macOS devices. The footer item uses the **complianceState** property to show a count of non-compliant devices.

![Managed Devices (Dash-stat)](/_images/image-(3881).png "Managed Devices (Dash-stat)")
...
![Non-compliant devices (Dash-stat)](/_images/image-(3882).png "Non-compliant devices (Dash-stat)")
...
![Non-compliant policies (Dash-stat)](/_images/image-(3883).png "Non-compliant policies (Dash-stat)")

Clicking this item loads a table list view of the full dataset. Items in the table list cannot be clicked.

![Table list view of the full dataset](/_images/image-(3884).png "Table list view of the full dataset")

### Intune compliance policies (Dash-stat)

Provides a total count of compliance policies targeting Windows and macOS devices.

![Intune compliance policies (Dash-stat)](/_images/image-(3885).png "Intune compliance policies (Dash-stat)")
...
![Device Compliance State (Donut chart)](/_images/image-(3886).png "Device Compliance State (Donut chart)")
...
![Device Compliance By Type (Donut chart)](/_images/image-(3887).png "Device Compliance By Type (Donut chart)")
...
![Policy Non-Compliant By Platforms (Donut chart)](/_images/image-(3888).png "Policy Non-Compliant By Platforms (Donut chart)")
...
![Compliance Policies By Platforms (Donut chart)](/_images/image-(3889).png "Compliance Policies By Platforms (Donut chart)")
...
![Non-Compliant devices (Table list)](/_images/image-(3890).png "Non-Compliant devices (Table list)")
...
![Configuration tab](/_images/image-(4289).png "Configuration tab")

### Managed Devices (Dash-stat)

Provides a total count of all Windows and macOS devices. The footer item uses the **complianceState** property to show a count of non-compliant devices.

![Managed Devices (Dash-stat)](/_images/image-(3892).png "Managed Devices (Dash-stat)")
...
![Device Configuration Profile Issues (Dash-stat)](/_images/image-(3893).png "Device Configuration Profile Issues (Dash-stat)")
...
![Table list view of the full dataset](/_images/image-(3894).png "Table list view of the full dataset")
...
![Autopilot Events (Dash-stat)](/_images/image-(151).png "Autopilot Events (Dash-stat)")
...
![Example table list](/_images/image-(152).png "Example table list")

### Autopilot Devices (Dash-stat)

Provides the total count of Autopilot-registered devices.

![Autopilot Devices (Dash-stat)](/_images/image-(153).png "Autopilot Devices (Dash-stat)")

Clicking this item loads a table list view of the full dataset. Items in the table list cannot be clicked on in the current release.

![Example table](/_images/image-(154).png "Example table")
...
![Device Encryption Summary (Donut chart)](/_images/image-(4356).png "Device Encryption Summary (Donut chart)")
...
![Configuration Profile Issues (Donut chart)](/_images/image-(3968).png "Configuration Profile Issues (Donut chart)")
...
![Example table](/_images/image-(3969).png "Example table")
...
![Autopilot Deployment States (Donut chart)](/_images/image-(3970).png "Autopilot Deployment States (Donut chart)")

Clicking any item in the donut chart opens a table view of the full dataset for that item. Items in the table list cannot be clicked.

![Example table](/_images/image-(3971).png "Example table")
...
![Autopilot Device Enrollment States (Donut chart)](/_images/image-(3972).png "Autopilot Device Enrollment States (Donut chart)")
...
![Example table](/_images/image-(3973).png "Example table")
...
![Unhealthy Defender Agents (Donut chart)](/_images/image-(3975).png "Unhealthy Defender Agents (Donut chart)")

Clicking any item in the donut chart opens a table view of the full dataset for that item. Clicking any item in the table opens the corresponding device modal.

![Example table](/_images/image-(3976).png "Example table")
...
![Autopilot Enrollment Profile States (Donut chart)](/_images/image-(3977).png "Autopilot Enrollment Profile States (Donut chart)")

Clicking any item in the donut chart opens a table view of the full dataset for that item. Items in the table list cannot be clicked.

![Example table](/_images/image-(3978).png "Example table")

## Operating Systems tab

All dashboard items in this view are populated using values from managed device properties.

![Operating Systems tab](/_images/image-(139).png "Operating Systems tab")

### Managed Devices (Dash-stat)

Provides a total count of all Windows and macOS devices. The footer item uses the **complianceState** property to show a count of non-compliant devices.

![Managed Devices (Dash-stat)](/_images/image-(140).png "Managed Devices (Dash-stat)")
...
![Windows 11 Devices (Dash-stat)](/_images/image-(141).png "Windows 11 Devices (Dash-stat)")
...
![Windows 10 Devices (Dash-stat)](/_images/image-(142).png "Windows 10 Devices (Dash-stat)")
...
![macOS Devices (Dash-stat)](/_images/image-(143).png "macOS Devices (Dash-stat)")
...
![Windows OS SKU (Donut chart)](/_images/image-(144).png "Windows OS SKU (Donut chart)")
...
![Windows 11 OS Builds (Donut chart)](/_images/image-(145).png "Windows 11 OS Builds (Donut chart)")
...
![Windows 10 OS Builds (Donut chart)](/_images/image-(146).png "Windows 10 OS Builds (Donut chart)")
...
![macOS Versions Count (Donut chart)](/_images/image-(147).png "macOS Versions Count (Donut chart)")
...
![Windows 11 Readiness Checks (Donut chart)](/_images/image-(148).png "Windows 11 Readiness Checks (Donut chart)")

Clicking any item in the donut chart opens a table view of the full dataset for that item. Each device listed in the table can also be clicked to launch the specific device modal.

![Example table](/_images/image-(149).png "Example table")
...
![Supported Windows Versions](/_images/image-(150).png "Supported Windows Versions")