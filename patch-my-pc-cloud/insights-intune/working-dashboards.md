...
![More detailed information table](/_images/image-(3795).png)
...
![Clicking the ellipsis and selecting Export](/_images/image-(3796).png)
...
![Changing views](/_images/image-(3797).png)
...
![Changed view](/_images/image-(3798).png)
...
![Clicking a toggle to show the filtered items](/_images/image-(3799).png)

The view updates to display the previously filtered items.

![View updating to show the filtered items.](/_images/image-(3800).png)
