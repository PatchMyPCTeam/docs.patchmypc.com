...
![More detailed information table](../../.gitbook/assets/image-\(3795\).png)
...
2. Click the ellipsis ()in the top right-hand corner of the device list portal and select **Export <**_**device\_list\_modal\_name**_**>**

![Clicking the ellipsis and selecting Export](../../.gitbook/assets/image-\(3796\).png)
...
Some Charts (such as **Device Specs**) include an action menu () that lets you switch the Chart between different views of the data.

To change the view of a Chart, click the action menu and select the desired view from the dropdown.

![Changing views](../../.gitbook/assets/image-\(3797\).png)
...
![Changed view](../../.gitbook/assets/image-\(3798\).png)
...
![Clicking a toggle to show the filtered items](../../.gitbook/assets/image-\(3799\).png)

The view updates to display the previously filtered items.

![View updating to show the filtered items.](../../.gitbook/assets/image-\(3800\).png)
