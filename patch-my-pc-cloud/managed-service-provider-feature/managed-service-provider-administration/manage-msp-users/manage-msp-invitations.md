...
![Navigating to 'MSP Customers'](../../../../.gitbook/assets/image-\(582\).png)
...
![Entering the email address of the user within the child company you want to invite in the 'Invite Customer' dialog box and clicking 'Send'](../../../../.gitbook/assets/image-\(584\).png)
...
![Invitation appearing under the ‘Invitations' tab and the ‘Success' message that the invitation has been sent.](../../../../.gitbook/assets/image-\(585\).png)
...
![Clicking the ‘Conditions' link](../../../../.gitbook/assets/image-\(586\).png)

2. Review the Terms and Conditions, then click the **X** to close them.

![Reviewing the terms and conditions](../../../../.gitbook/assets/image-\(587\).png)
...
![Accepting the invitation](../../../../.gitbook/assets/image-\(588\).png)
...
![Company of the user who accepted the invitation is shown under the ‘Customers' tab](../../../../.gitbook/assets/image-\(591\).png)
