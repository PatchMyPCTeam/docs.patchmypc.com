...
1.  Click the **Assignments** tab.<br>
    ...
    ![Clicking the "Assignments" tab](../../../.gitbook/assets/image-\(816\).png)
...
![Clicking "Enable Update Rings"](../../../.gitbook/assets/image-\(817\).png)

4.  Click **Add Assignment**\
    <br>

    ![Clicking "Add Assignment"](../../../.gitbook/assets/image-\(818\).png)
...
![Selecting the relevant company to assign this deployment to.](../../../.gitbook/assets/image-\(820\).png)

6. On the **Assignments** tab, select the relevant resources you want to deploy this app to and click **Save**.

![Selecting the relevant resources for this assignment](../../../.gitbook/assets/image-\(821\).png)
...
![Configuring any required settings for the assignments](../../../.gitbook/assets/image-\(822\).png)

9.  Click **Deploy** to deploy this App Set.<br>

    ![Clicking "Deploy" to deploy this App Set](../../../.gitbook/assets/image-\(824\).png)
...
!["App Sets" showing the newly created deployment](../../../.gitbook/assets/image-\(825\).png)
...
>
> !\[App Set deployment when viewed from the child company]\(/\_images/image-(826 "App Set deployment when viewed from the child company").png>)
...
![App Set showing with a status of "Success"](../../../.gitbook/assets/image-\(827\).png)
