...
The Managed Service Provider (MSP) _Application Sets_ (App Sets) feature of Patch My PC (PMPC) Cloud is designed to streamline the deployment and management of applications across multiple customers or tenants.
...
* [View details for an App Set](view-app-set-details.md)
