...
1.  Navigate to **App Sets**<br>
    ...
    ![Navigating to "App Sets"](/_images/image-(813 "Navigating to \"App Sets\"") (1).png>)
2.  Click the ellipsis (**⋮**) beside the App Set you want to edit and select **Edit**<br>

    ![Clicking the ellipsis beside the App Set you want to edit](/_images/image-(814 "Clicking the ellipsis beside the App Set you want to edit") (1).png>)
...
![Clicking "Deploy"](/_images/image-(815 "Clicking \"Deploy\"") (1).png>)