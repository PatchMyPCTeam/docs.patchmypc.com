...
<p>**Note**</p>
<p>Once the parent MSP company has been onboarded to PMPC Cloud, you can navigate to **Settings | Environments** and click the vertical ellipsis (**⋮**) beside the expiry date followed by **Activate License** to activate your MSP License without having to connect to Intune first.\</p>
<p>\</p>
<p>![](/_images/image-(3482).png)\</p>
<p>\</p>
