...
![Navigating to "Settings | Templates"](../../../../.gitbook/assets/image-\(959\).png)

2. Click the trash can beside the relevant template you want to delete.

![Clicking the trashcan beside the relevant template you want to delete.](../../../../.gitbook/assets/image-\(3702\).png)
...
!['Templates' page redisplayed along with the notification the template has been deleted](../../../../.gitbook/assets/image-\(3704\).png)
