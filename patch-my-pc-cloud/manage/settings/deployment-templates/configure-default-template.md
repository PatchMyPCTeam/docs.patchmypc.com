...
![Navigating to "Settings | Templates"](/_images/image-(963 "Navigating to \"Settings | Templates\"") (1).png>)
...
![Clicking the 'default' slider beside the relevant template](/_images/image-(3697).png)
...
![Clicking the slider under the 'Default' column beside the template currently configured as the default.](/_images/image-(3699).png)

2. On the A**re you sure you want to unset ‘<**_**template\_name**_**>’ template as the default** popup, click **Yes**.

![](/_images/image-(968) (1).png>)
