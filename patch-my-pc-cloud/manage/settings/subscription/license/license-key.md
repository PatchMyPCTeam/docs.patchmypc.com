...
![Navigating to 'Settings | Subscription'](/_images/image-(4217).png)

## View your License Key

To view your current PMPC Cloud license key, click the _eye_ icon:

![Clicking the eye icon](/_images/image-(4218).png)

Your full license key will then be shown:

![Full license key shown](/_images/image-(4219).png)

## Copy your License Key

To copy your current PMPC Cloud license key, click the license key.

![Clicking your license key](/_images/image-(4221).png)

The **Success - License Key copied** notification is shown.

![The 'Success - License Key copied' notification is shown](/_images/image-(4220).png)
...
![Clicking the pencil icon](/_images/image-(4224).png)

2. Paste/type the license key into the **Enter License Key** field, then click **Activate Now**.

![Entering the license key into the 'Enter License Key field' and clicking 'Activate Now'](/_images/image-(4230).png)

The **You have successfully activated your license** screen is displayed, which you can click **Close** on to dismiss.

!['You have successfully activated your license' screen](/_images/image-(4225).png)

The **License Key** field updates to show the newly activated license.

![Updated 'License Key' field](/_images/image-(4226).png)
...
!['License Screen' showing providing details of your current license](/_images/image-(3573).png)
...
![Entering the license key and clicking 'Activate Now'](/_images/image-(4227).png)
