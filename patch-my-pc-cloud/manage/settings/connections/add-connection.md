...
![Navigating to 'Settings | Connections'](../../../../.gitbook/assets/image-\(301\).png)

The **Connections** page is displayed showing any existing connections

!['Connections' page showing any existing connections](../../../../.gitbook/assets/image-\(302\).png)

2. Click **Connect Intune**

![Clicking 'Connect Intune'](../../../../.gitbook/assets/image-\(303\).png)
...
!['Sign in' prompt](../../../../.gitbook/assets/image-\(304\).png)

4. Enter the password and click **Sign in**.

![Entering the password](../../../../.gitbook/assets/image-\(305\).png)
...
![Clicking 'Accept' on the 'Permissions requested' screen](../../../../.gitbook/assets/image-\(306\).png)
...
![New Intune connection](../../../../.gitbook/assets/image-\(307\).png)
...
!['Publisher connection' screen](../../../../.gitbook/assets/image-\(308\).png)
...
![Clicking the 'Cloud' tab](../../../../.gitbook/assets/image-\(4849\).png)

3. On the **Cloud** tab, check the **Enable cloud connection** checkbox.

![Checking the 'Enable cloud connection' checkbox](../../../../.gitbook/assets/image-\(4850\).png)
...
![Entering a 'Connection name' and clicking 'Connect'](../../../../.gitbook/assets/image-\(4851\).png)
...
!['Microsoft Sign in' screen](../../../../.gitbook/assets/image-\(2122\).png)

5. Enter the password and click **Sign in**.

!['Enter password' screen](../../../../.gitbook/assets/image-\(2123\).png)
...
!['Select a customer for cloud connection' dialog](../../../../.gitbook/assets/image-\(4853\).png)
...
![Verifying the 'Connection Status' shows as 'Connected'](../../../../.gitbook/assets/image-\(4852\).png)

The new Publisher connection will be shown on the **Connections** page of the Cloud Portal.

![New Publisher connection](../../../../.gitbook/assets/image-\(4854\).png)
