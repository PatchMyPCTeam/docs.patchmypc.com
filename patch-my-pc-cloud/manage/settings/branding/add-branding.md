...
![Navigating to ‘Settings | Branding'](/_images/image-(545).png "Navigating to ‘Settings | Branding’")

2. Click **Add Branding**

![Clicking ‘Add Branding'](/_images/image-(546).png "Clicking ‘Add Branding’")
...
![Clicking ‘Modern(PSASDT)'](/_images/image-(547).png "Clicking ‘Modern(PSASDT)’")

<blockquote class="wp-block-quote">
<p>**Important**</p>
<p>When you select **Modern (PSADT)**, you will see the **Are you sure you want to switch branding types** prompt.</p>
<p>![‘Are you sure you want to switch branding type' prompt](/_images/unknown.png "‘Are you sure you want to switch branding type' prompt")</p>
<p>Click **Confirm** to continue.</p>
<p>You will also see the warning message that .NET Framework 4.7.2 or later is required on any devices on which a Modern branding app is targeted to.</p>
<p>![](/_images/unknown-(1).png>)&#x20;</p>
</blockquote>

<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>The process for creating a branding app is the same regardless of the **Branding Type**. The differences are with the configuration settings for each branding app, which are detailed in [Default Language Notifications in Cloud](default-language-notifications.md).</p>
</blockquote>
...
![Entering the name for the Branding app](/_images/image-(548).png "Entering the name for the Branding app")

<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>The **Notification Preview** does not update as you change the text in the various fields.</p>
</blockquote>
...
![Entering your company name](/_images/image-(549).png "Entering your company name")

7. Click **Upload Logo** to upload the logo for your branding that meets the requirements detailed on the **Branding** screen.

<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>The logo you are uploading must be less than 50 MB.</p>
</blockquote>

![Clicking ‘Upload Logo'](/_images/image-(550).png "Clicking ‘Upload Logo’")
...
![Notification Preview](/_images/image-(551).png "Notification Preview")
...
![‘Localizations' section](/_images/image-(552).png "‘Localizations’ section")
...
![Clicking ‘Add Language'](/_images/image-(553).png "Clicking ‘Add Language’")
...
![Clicking the ‘Assignments' tab.](/_images/image-(3720).png "Clicking the ‘Assignments’ tab.")

2. Click **Add Assignment**

![Clicking ‘Add Assignment'](/_images/image-(3721).png "Clicking ‘Add Assignment’")
...
![Choosing the relevant Entra ID security groups to target for this branding app on the 'Add Required Assignment' screen, then clicking 'Save'](/_images/image-(3121).png "Choosing the relevant Entra ID security groups to target for this branding app on the &#x27;Add Required Assignment&#x27; screen, then clicking &#x27;Save&#x27;")

The **Assignments** tab is redisplayed, showing all of the assignments for this branding app.

![‘Assignments' tab is redisplayed.](/_images/image-(3722).png "‘Assignments’ tab is redisplayed.")
...
![Clicking ‘Save'](/_images/image-(3723).png "Clicking ‘Save’")

The **Success – Branding created** notification is displayed, and the Status of the branding app is shown as **In Progress**.

!['Success – Branding created' notification and the 'Status' of the branding app is shown as 'In Progress'](/_images/image-(3741).png "&#x27;Success – Branding created&#x27; notification and the &#x27;Status&#x27; of the branding app is shown as &#x27;In Progress&#x27;")
...
![‘Status' showing as ‘Success' and the ‘Last Updated' value is updated.](/_images/image-(3742).png "‘Status’ showing as ‘Success’ and the ‘Last Updated’ value is updated.")
...
![Branding app listed with all of your other apps](/_images/image-(3199).png "Branding app listed with all of your other apps")
