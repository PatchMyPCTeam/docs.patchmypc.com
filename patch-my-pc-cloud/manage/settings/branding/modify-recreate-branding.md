...
![Navigating to ‘Settings | Branding'](/_images/image-(536 "Navigating to ‘Settings | Branding'") (1).png>)
...
![Clicking 'Use Default' in the 'Company Logo' area](/_images/image-(538 "Clicking 'Use Default' in the 'Company Logo' area") (1).png>)

The **Branding** page resets just the logo to the default for this branding app.

![Branding logo reset](/_images/image-(539 "Branding logo reset") (1).png>)

3. If you want to switch branding types, select the relevant option under **Branding Types**

![Select the relevant option under 'Branding Types' if you want to change the type](/_images/image-(540 "Select the relevant option under 'Branding Types' if you want to change the type") (1).png>)
...
![Clicking 'Save' to save your changes](/_images/image-(542 "Clicking 'Save' to save your changes") (1).png>)
