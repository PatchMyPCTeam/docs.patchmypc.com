...
![Clicking 'Add Language'](/_images/image-(3726).png)
...
![Typing the name of the relevant language or selecting it from the 'Language' dropdown of the 'Add Localization' screen](/_images/image-(4238).png)
...
![Completing all of the fields on all of the tabs](/_images/image-(4239).png)
...
![Clicking 'Save' to save your settings](/_images/image-(4240).png)
...
!['Branding' screen redisplayed with the newly added localization shown at the top of the list allowing you to select it if required](/_images/image-(3727).png)
...
![Clicking the pencil icon beside the relevant language](/_images/image-(3728).png)

4. Make any required changes, then click **Save** to save your changes.

![Clicking 'Save'](/_images/image-(4241).png)

The **Branding** screen is redisplayed.

!['Branding' screen is redisplayed](/_images/image-(3729).png)

5. Click **Save** to save your changes.

![Clicking 'Save' to save your changes](/_images/image-(3730).png)

The list of branding apps is displayed along with the **Success – Branding Updated** notification.

!['Success – Branding Updated' notification](/_images/image-(3749).png)
...
![Clicking the red trashcan beside the language you want to remove](/_images/image-(3732).png)

The language is removed.

3. Click **Save** to save your changes.

![Clicking 'Save' to save your changes](/_images/image-(3734).png)

The **Success – Branding updated** notification is displayed.

!['Success – Branding updated' notification](/_images/image-(3750).png)