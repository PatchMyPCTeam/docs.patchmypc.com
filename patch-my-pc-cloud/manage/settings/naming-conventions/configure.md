...
2.  Click on the relevant tab for the type of apps you want to configure naming conventions for.<br>
    ...
    ![Clicking the relevant tab for the type of app to configure](/_images/image-(1361).png "Clicking the relevant tab for the type of app to configure")
...
4.  Click **Save** to save your changes.<br>
    ...
    ![Clicking "Save" to save your changes](/_images/image-(1362).png "Clicking “Save” to save your changes")

    \
    The **Success – Naming Conventions saved** notification is displayed.<br>

    !["Success – Naming Conventions saved" notification](/_images/image-(2479).png "&#x22;Success – Naming Conventions saved&#x22; notification")
