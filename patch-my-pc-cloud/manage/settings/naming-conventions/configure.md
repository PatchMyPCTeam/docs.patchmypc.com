...
2.  Click on the relevant tab for the type of apps you want to configure naming conventions for.<br>
    ...
    ![Clicking the relevant tab for the type of app to configure](../../../../.gitbook/assets/image-\(1361\).png)
...
4.  Click **Save** to save your changes.<br>
    ...
    ![Clicking "Save" to save your changes](../../../../.gitbook/assets/image-\(1362\).png)
