...
See [Cloud Product Limits](../../../product-limits.md) for more information.
{% endhint %}
...
<figure><img src="../../../../.gitbook/assets/image (3399).png" alt="Navigating to “Settings | Company”" width="563"><figcaption></figcaption></figure>

2. On the **Company** page, click the **Usage** tab.

<figure><img src="../../../../.gitbook/assets/image (3400).png" alt="Clicking the “Usage” tab" width="563"><figcaption></figcaption></figure>
...
See [Cloud User Roles Reference](../users/user-roles-reference.md) for more information.

Also, any devices managed by Microsoft Defender for Endpoint (MDE) are not included in device counts.
{% endhint %}

<figure><img src="../../../../.gitbook/assets/image (3414).png" alt="“Usage&#x22; information" width="523"><figcaption></figcaption></figure>
