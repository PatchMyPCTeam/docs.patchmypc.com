...
2.  In the **Roles** column, click the down arrow and select the relevant role you want to assign to the user.\
    ...
    <figure><img src="../../../../.gitbook/assets/image (2820).png" alt="Selecting the required user role from the list of roles dropdown" width="563"><figcaption></figcaption></figure>

    \
    The role for the user will be updated and the **Success - Role changed** notification is displayed.<br>

    <figure><img src="../../../../.gitbook/assets/image (2350).png" alt="“Success - Role changed” notification" width="563"><figcaption></figcaption></figure>

{% hint style="info" %}
**Note**

See [User Roles](user-roles-reference.md) for more information on the user roles available.
{% endhint %}
...
<figure><img src="../../../../.gitbook/assets/image (2351).png" alt="Using the slider to grant “Access Management” privileges" width="563"><figcaption></figcaption></figure>

The **Success - Role changed** notification is displayed.

<figure><img src="../../../../.gitbook/assets/image (2352).png" alt="The “Success - Role changed&#x22; notification" width="563"><figcaption></figcaption></figure>
...
!["Are you sure you want to revoke access management from your account" pop up](<../../../../.gitbook/assets/image (2461).png>)&#x20;
{% endhint %}
