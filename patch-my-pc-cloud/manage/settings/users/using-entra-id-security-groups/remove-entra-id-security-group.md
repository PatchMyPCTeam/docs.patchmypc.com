...
1.  In the PMPC Cloud portal, navigate to **Settings | Users**.<br>
    ...
    ![Navigating to "Settings | Users"](/_images/image-(2936).png)
2.  Click the **Entra ID Groups** tab.<br>

    ![Clicking the "Entra ID Groups" tab](/_images/image-(2937).png)
...
![Clicking the trashcan beside the relevant Entra group you want to delete](/_images/image-(2938).png)

4. On the **Are you sure you want to remove <**_**group\_name**_**>** dialog box, click **Yes** to confirm the removal.

!['Are you sure' you want to remove group dialog box](/_images/image-(3634).png)

The portal auto-refreshes to show the group has been removed and the **Success – Group deleted** notification is shown.

![Portal auto-refreshing to show the group has been removed and the "Success – Group deleted" notification is shown](/_images/image-(2940).png)
