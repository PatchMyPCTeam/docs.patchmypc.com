...
<p>**Note**</p>
<p>See [Managing Invitations](../invitations/) for more information on invitations.</p>
</blockquote>
...
<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>Clicking **Review Request** in the email takes you to the **Pending Approval** page. To see an example of the access request email, see [Example Access Request email](../../../../technical-references/cloud-email-reference/example-cloud-access-request-email.md).</p>
</blockquote>

![Navigating to "Settings | Users | Pending Approval"](/_images/image-(1395).png "Navigating to “Settings | Users | Pending Approval”")

Any pending approvals are shown.

![List of Pending Approvals](/_images/image-(1320).png "List of Pending Approvals")
