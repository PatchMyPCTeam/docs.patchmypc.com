...
<p>**Note**</p>
<p>Support for Script-based apps is still in development and is expected to be available soon.</p>
</blockquote>
...
![Script-based app identified from the installation program](/_images/image-(3824).png "Script-based app identified from the installation program")
...
![Script-based app shown in the deployment flow](/_images/image-(3822).png "Script-based app shown in the deployment flow")
...
![Script-based app flow](/_images/image-(3823).png "Script-based app flow")

<blockquote class="wp-block-quote">
<p>**Important**</p>
<p>If the script is code-signed, any modification on the **File** tab will invalidate the existing signature. For this reason, editing should only be performed on unsigned scripts. Signed scripts should be exported, re-signed after any changes, and then re-imported before completing the migration.</p>
</blockquote>
