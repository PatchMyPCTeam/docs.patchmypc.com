...
![EXE-based app identified from the installation program](../../../.gitbook/assets/image-\(317\).png)
...
![EXE-based app shown in the deployment flow](../../../.gitbook/assets/image-\(318\).png)
