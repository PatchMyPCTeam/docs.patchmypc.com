...
![Refresh migration data](/_images/image-(25 "Refresh migration data") (1).png>)
...
![Full resync of migration data](/_images/image-(322 "Full resync of migration data") (1).png>)
...
![Lost connection to the Publisher](/_images/image-(314 "Lost connection to the Publisher") (1).png>)
...
![Restart the Publisher service to restore the connection](/_images/image-(315 "Restart the Publisher service to restore the connection") (1).png>)