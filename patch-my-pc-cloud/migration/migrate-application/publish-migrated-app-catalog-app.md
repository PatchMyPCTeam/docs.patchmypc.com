...
![Application migration status](/_images/image-(606 "Application migration status") (1).png>)
...
![Migrated application as seen in the Intune admin center](/_images/image-(608 "Migrated application as seen in the Intune admin center") (1).png>)