...
As this is a preview feature, you must [Enable Preview Features](../manage/settings/company-settings/preview-features.md) for the **Discovery** node to appear in your portal.
{% endhint %}
