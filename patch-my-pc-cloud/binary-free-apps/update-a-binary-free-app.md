...
![Clicking "Add Version" in the notification email](/_images/image-(1103).png)

2. If required, click **Sign In** on the new browser tab prompting you to sign in to your portal.

![Clicking "Sign In" on the new browser tab prompting you to sign in to your portal.](/_images/image-(1104).png)
...
![Clicking "Select Application File"](/_images/image-(1106).png)
...
![Calculating the hash for the file as its uploaded to your portal](/_images/image-(1107).png)
...
!["Success – File Successfully Uploaded" notification](/_images/image-(1108).png)
...
!["Upload" icon showing a new version of an app needs to be uploaded](/_images/image-(1110).png)
...
![Clicking "Manage Files"](/_images/image-(1111).png)
