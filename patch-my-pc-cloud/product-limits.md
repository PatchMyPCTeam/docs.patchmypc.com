...
<p>**Note**</p>
<p>If you are using a Not For Resale (NFR) license, this type of license has the same limits as a Trial Customer.</p>
<p>Also, Managed Service Provider licenses have different limits as detailed in [Patch My PC Cloud Product Limits for Managed Service Provider Licenses](managed-service-provider-feature/product-limits.md).</p>
</blockquote>
