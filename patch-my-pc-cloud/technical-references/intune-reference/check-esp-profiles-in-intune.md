...
2.  Navigate to **Devices**<br>
    ...
    ![Navigating to "Devices"](/_images/image-(828).png)
3.  Navigate to **Enrollment**<br>

    ![Navigating to "Enrollment"](/_images/image-(978).png)
4.  Scroll down and select **Enrollment Status Page**<br>

    ![Scrolling down and selecting "Enrollment Status Page"](/_images/image-(979).png)
5.  On the **Enrollment Status Page** click the relevant profile the PMPC Cloud deployment has been added to.<br>

    ![Clicking the relevant profile the PMPC Cloud deployment has been added to](/_images/image-(980).png)
6.  On the _**\<profile\_name>**_ page, navigate to **Manage | Properties**<br>

    ![Navigating to "Manage | Properties"](/_images/image-(981).png)
