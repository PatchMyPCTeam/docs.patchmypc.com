...
2.  Navigate to **Devices**<br>
    ...
    ![Navigating to "Devices"](<../../../.gitbook/assets/image-(828) (1).png>)
3.  Navigate to **Enrollment**<br>

    ![Navigating to "Enrollment"](<../../../.gitbook/assets/image-(978) (1).png>)
4.  Scroll down and select **Enrollment Status Page**<br>

    ![Scrolling down and selecting "Enrollment Status Page"](<../../../.gitbook/assets/image-(979) (1).png>)
5.  On the **Enrollment Status Page** click the relevant profile the PMPC Cloud deployment has been added to.<br>

    ![Clicking the relevant profile the PMPC Cloud deployment has been added to](<../../../.gitbook/assets/image-(980) (1).png>)
6.  On the _**\<profile\_name>**_ page, navigate to **Manage | Properties**<br>

    ![Navigating to "Manage | Properties"](<../../../.gitbook/assets/image-(981) (1).png>)
