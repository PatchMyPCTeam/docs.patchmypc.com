...
!["Unable to change the role of this group as it was not found in Entra ID" error](/_images/image-(2994).png)
...
!["Group role was deleted on Azure" error](/_images/image-(1050).png)
