...
<figure><img src="../../../.gitbook/assets/image (1068).png" alt="&#x22;Group not found&#x22; shown beside the assignment for a successful assignment."><figcaption></figcaption></figure>

If I edit the deployment and click **Assignments**, I also see the **Group not found. Please remove the assignment** message.

<figure><img src="../../../.gitbook/assets/image (1067).png" alt="&#x22;Group not found. Please remove the assignment&#x22; message"><figcaption></figcaption></figure>
...
See the [Edit a Deployment](../../deployments/manage-deployments/edit.md) process for more details.
{% endhint %}
