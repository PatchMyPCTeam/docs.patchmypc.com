...
!["Group not found" shown beside the assignment for a successful assignment.](/_images/image-(1068).png "&#x22;Group not found&#x22; shown beside the assignment for a successful assignment.")

If I edit the deployment and click **Assignments**, I also see the **Group not found. Please remove the assignment** message.

!["Group not found. Please remove the assignment" message](/_images/image-(1067).png "&#x22;Group not found. Please remove the assignment&#x22; message")
...
<p>See the [Edit a Deployment](../../deployments/manage-deployments/edit.md) process for more details.</p>
</blockquote>