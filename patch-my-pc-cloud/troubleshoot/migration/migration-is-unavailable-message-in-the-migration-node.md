...
!["Migration is Unavailable"](/_images/image-(3420).png)
...
![Clicking the "Cloud" tab](/_images/image-(3421).png)

3. Ensure the **Enable Application Migration** checkbox is checked.

![Ensuring the "Enable Application Migration" checkbox is checked](/_images/image-(3422).png)