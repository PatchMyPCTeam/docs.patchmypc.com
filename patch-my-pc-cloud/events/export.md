...
![Clicking "Export" in the header of the "Events" page](/_images/image-(2474).png "Clicking “Export” in the header of the “Events” page")
...
![Example of the "events_log_entries.csv" file](/_images/image-(799).png "Example of the “events_log_entries.csv” file")

<blockquote class="wp-block-quote">
<p>**Tip**</p>
<p>You can use Filters to control which events you export, rather than exporting all events. See [Filter Events](filter.md) for more information.</p>
</blockquote>