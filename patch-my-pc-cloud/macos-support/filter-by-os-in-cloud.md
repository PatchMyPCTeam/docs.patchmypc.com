...
![Clicking the "List View" button](/_images/image-(2981).png "Clicking the “List View” button")
...
![New "OS" column shows which operating systems each app can be deployed to](/_images/image-(2982).png "New “OS” column shows which operating systems each app can be deployed to")
...
1.  On the **App Catalog** page, click the funnel button.<br>
    ...
    ![Clicking the funnel button.](/_images/image-(2983).png "Clicking the funnel button.")


2.  Click the checkbox for the OS you want to filter by (for example **macOS**), then click **Apply All Filters**.\
    <br>

    ![Checking the relevant checkbox for the OS you want to filter by then clicking "Apply All Filters"](/_images/image-(991).png "Checking the relevant checkbox for the OS you want to filter by then clicking “Apply All Filters”")
...
![App Catalog updating to show only the apps that match the selected filters.](/_images/image-(992).png "App Catalog updating to show only the apps that match the selected filters.")
