...
![Clicking the "List View" button](../../.gitbook/assets/image-\(2981\).png)
...
![New "OS" column shows which operating systems each app can be deployed to](../../.gitbook/assets/image-\(2982\).png)
...
1.  On the **App Catalog** page, click the funnel button.<br>
    ...
    ![Clicking the funnel button.](../../.gitbook/assets/image-\(2983\).png)
2.  Click the checkbox for the OS you want to filter by (for example **macOS**), then click **Apply All Filters**.\
    <br>

    ![Checking the relevant checkbox for the OS you want to filter by then clicking "Apply All Filters"](<../../.gitbook/assets/image-(991) (1).png>)
...
![App Catalog updating to show only the apps that match the selected filters.](../../.gitbook/assets/image-\(992\).png)
