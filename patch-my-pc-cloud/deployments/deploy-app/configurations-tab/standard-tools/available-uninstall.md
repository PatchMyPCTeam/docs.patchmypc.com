...
![Clicking the 'Available Uninstall' tool](/_images/image-(665 "Clicking the 'Available Uninstall' tool") (1).png>)

2. Configure the settings as required.

!['Available Uninstall' settings](/_images/image-(666 "'Available Uninstall' settings") (1).png>)
