...
![Clicking the 'Return Codes' tool](/_images/image-(657).png)
...
![Default return codes](/_images/image-(659).png)
...
![Adding a new Return Code](/_images/image-(766).png)

The new Return Code is added to the list.

![New Return Code added to the list.](/_images/image-(767).png)

5. If you do not want to edit a Return Code, go to Step 9.
6. To edit a Return Code, click the pencil icon beside it.

![Clicking the pencil icon beside a Return Code to edit it.](/_images/image-(768).png)

7. Make any required changes.
8. Click the green tick to save your changes.

![Clicking the green tick to save your changes](/_images/image-(769).png)

The **Code type** field is updated.

!["Code type" field updated.](/_images/image-(770).png)
...
![Code deleted from the list](/_images/image-(772).png)
