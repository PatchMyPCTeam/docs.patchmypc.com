...
![Clicking the 'Return Codes' tool](/_images/image-(657 "Clicking the 'Return Codes' tool") (1).png>)
...
![Default return codes](/_images/image-(659 "Default return codes") (1).png>)
...
![Adding a new Return Code](/_images/image-(766 "Adding a new Return Code") (1).png>)

The new Return Code is added to the list.

![New Return Code added to the list.](/_images/image-(767 "New Return Code added to the list.") (1).png>)

5. If you do not want to edit a Return Code, go to Step 9.
6. To edit a Return Code, click the pencil icon beside it.

![Clicking the pencil icon beside a Return Code to edit it.](/_images/image-(768 "Clicking the pencil icon beside a Return Code to edit it.") (1).png>)

7. Make any required changes.
8. Click the green tick to save your changes.

![Clicking the green tick to save your changes](/_images/image-(769 "Clicking the green tick to save your changes") (1).png>)

The **Code type** field is updated.

!["Code type" field updated.](/_images/image-(770 "\"Code type\" field updated.") (1).png>)
...
![Deleting a Return Code](/_images/image-(771).png)

The code is deleted from the list.

![Code deleted from the list](/_images/image-(772 "Code deleted from the list") (1).png>)
