...
![Clicking 'Import' to import an existing script](/_images/image-(44 "Clicking 'Import' to import an existing script") (1).png>)
...
!['Add Pre-Uninstall Script' page is populated with the imported script.](/_images/image-(45 "'Add Pre-Uninstall Script' page is populated with the imported script.") (1).png>)

3. To manually add a script, enter a unique name for the script in the **Script Name** field.

![Entering a unique name for the script in the 'Script Name' field](/_images/image-(46 "Entering a unique name for the script in the 'Script Name' field") (1).png>)

4. Select the type of script from the **Script Format** dropdown.

![Selecting the type of script from the 'Script Format' dropdown.](/_images/image-(47 "Selecting the type of script from the 'Script Format' dropdown.") (1).png>)

5. In the script editor, type your script.

![Typing your script in the script editor](/_images/image-(48 "Typing your script in the script editor") (1).png>)
...
![Entering any arguments you want to provide to the script by specifying them in the 'Arguments' field](/_images/image-(49 "Entering any arguments you want to provide to the script by specifying them in the 'Arguments' field") (1).png>)
...
![Checking the 'Don't attempt software uninstall if the pre script returns an exit code other than 0 or 3010' checkbox](/_images/image-(50 "Checking the 'Don't attempt software uninstall if the pre script returns an exit code other than 0 or 3010' checkbox") (1).png>)
...
![Checking the 'Run the pre-uninstall script before performing any auto-close or skip process checks' checkbox](/_images/image-(51 "Checking the 'Run the pre-uninstall script before performing any auto-close or skip process checks' checkbox") (1).png>)

9. Click **Save** to save your script.

![Clicking 'Save' to save your script](/_images/image-(52 "Clicking 'Save' to save your script") (1).png>)

The **Configurations** tab is re-displayed with the name of the configured script beside it.

![](/_images/image-(797) (1).png>)
