...
These optional settings are grouped into a series of related _Additional Tools_, which can be added (and, if needed, removed) to a deployment.
...
![Clicking 'Add' and selecting an additional tool(s) to add to the list of 'Additional Tools'](/_images/image-(653 "Clicking 'Add' and selecting an additional tool(s) to add to the list of 'Additional Tools'") (1).png>)
