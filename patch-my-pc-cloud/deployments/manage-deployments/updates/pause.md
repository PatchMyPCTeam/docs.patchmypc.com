...
Click the filter button (![](<../../../../.gitbook/assets/image (3215).png>)) and select the **Disabled** option under the **Updates** section, followed by **Apply Filters** to see just those deployments that do not have updates paused.&#x20;
{% endhint %}

<figure><img src="../../../../.gitbook/assets/image (2490).png" alt="Clicking on the relevant successful deployment you want to pause for updates "><figcaption></figcaption></figure>

2.  Click the **Pause Updates** slider to enable it.<br>

    <figure><img src="../../../../.gitbook/assets/image (2699).png" alt="Clicking the “Pause Updates” slider"><figcaption></figcaption></figure>


3.  Click the **X** to close the deployment properties page.<br>

    <figure><img src="../../../../.gitbook/assets/image (2700).png" alt="Clicking &#x22;X&#x22; to close the deployment properties page."><figcaption></figcaption></figure>
