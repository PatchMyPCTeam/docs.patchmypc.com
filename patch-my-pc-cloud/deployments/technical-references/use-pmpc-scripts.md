...
!["Customer Scripts | PMPC Scripts" toggle](/_images/image-(3432).png)

Contrast this to an app that does not include any recommended scripts.

![App without the "Customer Scripts | PMPC Scripts" toggle](/_images/image-(3433).png)
...
![Clicking "PMPC Scripts"](/_images/image-(3434).png)

Any recommended scripts included with the app are shown.

![Recommended PMPC Scripts](/_images/image-(3435).png)
...
![Script editor window](/_images/image-(3436).png)
...
![Navigating to the "Configurations" tab](/_images/image-(3437).png)

3. Click the **Scripts** tool if it is not already selected.

![Clicking the "Scripts" tool](/_images/image-(3438).png)

4. Click **PMPC Scripts**

![Clicking "PMPC Scripts"](/_images/image-(3439).png)

5. Click **Edit** beside the relevant script.

![Clicking "Edit" beside the relevant script](/_images/image-(3440).png)
...
![Checking the required "Pre-install checkboxes.](/_images/image-(3441).png)
...
![Checking the "Disable the Patch My PC Recommended Post-Install for this product" checkbox](/_images/image-(3442).png)
...
![Red circle is shown beside the script to indicate this and that it will not be included as part of the deployment.](/_images/image-(3443).png)
