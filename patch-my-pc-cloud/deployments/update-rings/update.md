...
2.  Click the relevant deployment to open its properties then click **More Info**.<br>
    ...
    ![Clicking "More Info"](/_images/image-(2845).png "Clicking “More Info”")


3.  If you can update a ring to a newer version the **Update Now** button is available.<br>

    !["Update Now" button available](/_images/image-(2846).png "“Update Now” button available")
...
4.  Click **Update Now** and select the relevant version you want to upgrade this ring to.<br>
    ...
    ![Selecting which version to update this ring to](/_images/image-(2847).png "Selecting which version to update this ring to")


5.  On the **Update “<**_**deployment\_name**_**>” ring to version <**_**version\_number**_**>** dialog box, click **Confirm**.<br>

    ![Clicking "Confirm"](/_images/image-(2849).png "Clicking “Confirm”")
    ...
    ![Version number has changed and "Update Now" button is unavailable.](/_images/image-(2851).png "Version number has changed and “Update Now” button is unavailable.")