...
* [Delayed](new-versions.md#how-delayed-update-rings-handle-new-versions)
* [Immediate](new-versions.md#how-immediate-update-rings-handle-new-versions)
...
![Configuring a phased deployment using Delayed Update Rings in PMPC Cloud](/_images/image-(2901).png "Configuring a phased deployment using Delayed Update Rings in PMPC Cloud")
...
![Version 2019.1 successfully deployed](/_images/image-(2903).png "Version 2019.1 successfully deployed")
...
![Only the assignment for the first update rings has been created and applied to this version.](/_images/image-(2904).png "Only the assignment for the first update rings has been created and applied to this version.")
...
![Ring 2 scheduled to be created two days after the deployment was created](/_images/image-(2905).png "Ring 2 scheduled to be created two days after the deployment was created")
...
![Second Update Ring has been created, which has added the assignment to the "dBase All Users" group.](/_images/image-(2906).png "Second Update Ring has been created, which has added the assignment to the “dBase All Users” group.")
...
![Properties of the deployment showing the second Update Ring has been created and assigned to the "dBase All Users" group.](/_images/image-(2907).png "Properties of the deployment showing the second Update Ring has been created and assigned to the “dBase All Users” group.")
...
* Run the [Sync Now](../manage-deployments/updates/sync-now.md) process to update just this deployment immediately.

<blockquote class="wp-block-quote">
<p>**Note**</p>
<p>This is one of the many reasons why we recommend configuring your [Sync Schedule](../../manage/settings/sync-schedule.md) to **Daily** if you are using Update Rings.</p>
...
![Version 2019.2 targeted to the "dBase Pilot Users" Update Ring.](/_images/image-(2908).png "Version 2019.2 targeted to the “dBase Pilot Users” Update Ring.")

But if you click on **Ring 2**, you will see that version **2019.1** is still assigned to the **dBase All Users** group.

!["Ring 2" is still assigned version 2019.1 and assigned to the "dBase All Users" group](/_images/image-(2909).png "“Ring 2” is still assigned version 2019.1 and assigned to the “dBase All Users” group")
...
![Intune admin center shows both the existing app (version 2019.1) and the new version we have just deployed (version 2019.2).](/_images/image-(2910).png "Intune admin center shows both the existing app (version 2019.1) and the new version we have just deployed (version 2019.2).")
...
![Updated assignment for the original version (2019.1)](/_images/image-(2911).png "Updated assignment for the original version (2019.1)")
...
![Assignments for the new deployment (version 2019.2) is only assigned for now to the dBase Pilot Users group.](/_images/image-(2912).png "Assignments for the new deployment (version 2019.2) is only assigned for now to the dBase Pilot Users group.")
...
![Assignments for the old version (2019.1) no longer has any assignments](/_images/image-(2913).png "Assignments for the old version (2019.1) no longer has any assignments")
...
![Configuring a phased deployment using Immediate Update Rings in PMPC Cloud](/_images/image-(2914).png "Configuring a phased deployment using Immediate Update Rings in PMPC Cloud")

When you deploy the software, you see the **Deployment Summary** of how the deployment will be handled.

![Deployment summary summarizing how the deployment will be handled](/_images/image-(2915).png "Deployment summary summarizing how the deployment will be handled")
...
![Version 2024.1 successfully deployed](/_images/image-(2916).png "Version 2024.1 successfully deployed")
...
![All assignments for each of the Update Rings created and applied to this version.](/_images/image-(2917).png "All assignments for each of the Update Rings created and applied to this version.")
...
It is only when a [new version](new-versions.md#new-version-released-1) of the targeted software gets released (current plus one or n+1), do the assignments from the previous version get moved to the latest version and Update Rings start to function as configured.
...
![Version 2024.2 targeted to the "Corel Pilot Users" Update Ring.](/_images/image-(2918).png "Version 2024.2 targeted to the “Corel Pilot Users” Update Ring.")

But if you click on **Ring 2**, you will see that version **2024.1** is still assigned to the **Corel All Users** group.

!["Ring 2" is still assigned version 2024.1 and assigned to the "Corel All Users" group](/_images/image-(2919).png "“Ring 2” is still assigned version 2024.1 and assigned to the “Corel All Users” group")
...
![Intune admin center shows both the existing app (version 2024.1) and the new version we have just deployed (version 2024.2).](/_images/image-(2920).png "Intune admin center shows both the existing app (version 2024.1) and the new version we have just deployed (version 2024.2).")
...
![Updated assignment for the original version (2024.1)](/_images/image-(2898).png "Updated assignment for the original version (2024.1)")
...
![Assignments for the new deployment (version 2024.2) is only assigned for now to the Corel Pilot Users group](/_images/image-(2899).png "Assignments for the new deployment (version 2024.2) is only assigned for now to the Corel Pilot Users group")
...
![Assignments for the old version (2024.1) no longer has any assignments](/_images/image-(2900).png "Assignments for the old version (2024.1) no longer has any assignments")
