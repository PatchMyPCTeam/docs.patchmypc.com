...
2.  Click **More Info**.<br>
    ...
    ![Clicking "More Info"](../../../.gitbook/assets/image-\(1157\).png)
...
![Configured Update Rings showing as tabs](../../../.gitbook/assets/image-\(1158\).png)

3.  Click the red **X** in the top right-hand corner to close the **More Info** page and return to the **Deployments** node.<br>

    ![Clicking the red X  in the top right-hand corner to close the "More Info" page and return to the "Deployments" node](../../../.gitbook/assets/image-\(1159\).png)
