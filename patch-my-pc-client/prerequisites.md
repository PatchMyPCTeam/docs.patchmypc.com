...
* If you have TLS encryption enabled on your endpoints, you need to allow:\
  **\*.patchmypc.com** and **portal.patchmypc.com**
* Configure an **allow** rule on your firewall for the following:

<table><thead><tr><th width="208.111083984375" valign="top">Domain</th><th width="249.99993896484375" valign="top">Reason</th><th width="69.00006103515625" valign="top">Port</th><th width="115.33331298828125" valign="top">Protocol</th></tr></thead><tbody><tr><td valign="top">*.digicert.com</td><td valign="top">CRL checking</td><td valign="top">80</td><td valign="top">http</td></tr><tr><td valign="top">*.portal.patchmypc.com</td><td valign="top">Client communication</td><td valign="top">443</td><td valign="top">https</td></tr><tr><td valign="top">api.patchmypc.com</td><td valign="top">Client communication</td><td valign="top">443</td><td valign="top">https</td></tr><tr><td valign="top">portal.patchmypc.com</td><td valign="top">region discovery/geolocation (required for client enrollment in all regions)</td><td valign="top">443</td><td valign="top">https</td></tr></tbody></table>
