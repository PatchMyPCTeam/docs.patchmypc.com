...
![Navigating to ‘Advanced/Patch Insights | Home'](/_images/image-(3801).png)
...
![Clicking the ellipsis followed by 'View Chart Data'](/_images/image-(4547).png)

The **Client Version** device list modal is displayed.

!['Client Version' device list modal](/_images/image-(4548).png)

3. Check the checkbox beside the client(s) you want to delete, then from the **Action** menu, select **Delete x Device**

![Selecting the client to be deleted and deleting it.](/_images/image-(4549).png)

4. On the **Are you sure** dialog, click **OK** to confirm the deletion.

![Clicking 'OK' on the 'Are you sure' dialog](/_images/image-(4550).png)
...
!['Client Version' device list modal showing the client has been deleted along with the success notification](/_images/image-(4551).png)