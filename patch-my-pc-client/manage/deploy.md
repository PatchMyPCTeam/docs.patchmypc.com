...
![Navigating to 'Settings | Deploy Client'](/_images/image-(593 "Navigating to 'Settings | Deploy Client'") (1).png>)
...
!['Deploy Client Deployment' screen](/_images/image-(594 "'Deploy Client Deployment' screen") (1).png>)
...
![Selecting the Entra ID Group(s) you want to deploy the client to](/_images/image-(595 "Selecting the Entra ID Group(s) you want to deploy the client to") (1).png>)

3. Click **Save**

![Clicking 'Save'](/_images/image-(596 "Clicking 'Save'") (1).png>)

The **Success - Created** notification is shown.

!['Success – Created' notification](/_images/image-(603 "'Success – Created' notification") (1).png>)
