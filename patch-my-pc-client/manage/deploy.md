...
![Navigating to 'Settings | Deploy Client'](<../../.gitbook/assets/image-(593) (1).png>)
...
!['Deploy Client Deployment' screen](<../../.gitbook/assets/image-(594) (1).png>)
...
![Selecting the Entra ID Group(s) you want to deploy the client to](<../../.gitbook/assets/image-(595) (1).png>)

3. Click **Save**

![Clicking 'Save'](<../../.gitbook/assets/image-(596) (1).png>)

The **Success - Created** notification is shown.

!['Success – Created' notification](<../../.gitbook/assets/image-(603) (1).png>)
